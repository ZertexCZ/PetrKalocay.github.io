...
// Language popup component is commented out for now
// To restore the language popup, uncomment the code below and remove the placeholder component

// COMMENTED OUT LANGUAGE POPUP START
...
//   );
// }
// COMMENTED OUT LANGUAGE POPUP END

// Placeholder component that doesn't show the language popup
...
export function LanguageSelector({ onSelectLanguage }: LanguageSelectorProps) {
  ...
  // Set default language to English without showing popup
  useEffect(() => {
    setLanguage('en');
  }, [setLanguage]);

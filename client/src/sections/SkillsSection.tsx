...
const SkillsSection = () => {
  ...
  const skillsData = [
    {
      name: (translations as any)[language].webDev,
      icon: 'ri-code-s-slash-line',
      description: (translations as any)[language].webDevDesc
    },
    {
      name: (translations as any)[language].programming,
      icon: 'ri-terminal-box-line',
      description: (translations as any)[language].programmingDesc
    },
    {
      name: (translations as any)[language].hardware,
      icon: 'ri-computer-line',
      description: (translations as any)[language].hardwareDesc
    },
    {
      name: (translations as any)[language].aiDev,
      icon: 'ri-robot-line',
      description: (translations as any)[language].aiDevDesc
    },
    {
      name: (translations as any)[language].leadership,
      icon: 'ri-team-line',
      description: (translations as any)[language].leadershipDesc
    },
    {
      name: (translations as any)[language].problemSolving,
      icon: 'ri-lightbulb-line',
      description: (translations as any)[language].problemSolvingDesc
    }
  ];
  ...
  return (
    ...
    >
      {/* Vzor pozadí digitálního obvodu */}
      ...
      {/* Pozadí se sloupci binárního kódu */}
      ...
      {/* Efekt pohybujících se částic na pozadí */}
      ...
      <div className="container mx-auto">
        <div className="max-w-5xl mx-auto">
          <div className="section-heading">
            <h2>
              {(translations as any)[language].skillsTitle.split(' & ')[0]} & <span className="text-accent">{(translations as any)[language].skillsTitle.split(' & ')[1]}</span>
            </h2>
            <div></div>
          </div>
          ...
          <div className="mt-16">
            <h3 className="text-xl md:text-2xl font-clash font-semibold mb-6">{(translations as any)[language].certifications}</h3>
            <div className="flex flex-wrap gap-3">
              {[
                (translations as any)[language].ecdlM2,
                (translations as any)[language].ecdlM3,
                (translations as any)[language].ecdlM4,
                (translations as any)[language].ecdlM5,
                (translations as any)[language].ecdlM6,
                (translations as any)[language].ecdlM7,
                (translations as any)[language].ecdlM9,
                (translations as any)[language].ecdlM12,
                (translations as any)[language].ecdlM15,
                (translations as any)[language].moreInFuture
              ].map((cert, index) => (
                <div 
                  key={index} 
